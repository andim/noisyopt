...
To solve this optimization problems the package implements to algorithms:
...
- a stochastic gradient-descent like algorithm, called simultaneous perturbation stochastic approximation [Spall1998]_
...
If you use this package, you might want to read and cite the papers describing the relevant algorithms:
